...
creatures = {
    ...
    'Neutrals':[['FIRE_ELEMENTAL','WATER_ELEMENTAL'],['EARTH_ELEMENTAL','AIR_ELEMENTAL'],['WOLF'],['MUMMY'],['SNOW_APE','MANTICORE'],['DEATH_KNIGHT'],['PHOENIX']],
...
def main():
    ...
    root = XDB.load('GameMechanics/RPGStats/DefaultStats.2.xdb')
    ...
    root.save('GameMechanics/RPGStats/DefaultStats.xdb')
